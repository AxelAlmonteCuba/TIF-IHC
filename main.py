...
while True:
    ...
    if hands and buttonPressed is False:  # Si se detecta la mano
        ...
        xVal = int(np.interp(lmList[8][0], [width // 2, width], [0, width])) #ANCHO interpolando para dibujar las lineas
        yVal = int(np.interp(lmList[8][1], [150, height - 150], [0, height])) #LARGO
